...
/**
 * @title ChipHoldersVault2 — le fee che tornano a chi tiene il token (per la ChipFactory9)
 *
 * Come il primo, con l'RH4 ricomprato che va alla riserva della madre
 * (ChipFactory8) e non alla fabbrica dei chip (ChipFactory9).
 *
 ...
 */
contract ChipHoldersVault2 is ReentrancyGuard {
    ...
    constructor(
        ...
        ISwapRouter02 router_, IPoolManager poolManager_, address hook_, address executor_, address rh4Sink_
    ) {
        rh4Sink = rh4Sink_;
