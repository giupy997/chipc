...
contract ChipBuybackVault3Test is Test {
    ChipBuybackVault3 vault; MockNPM npm; MockWETH weth; ChipTok chipTok; Tok nvda; Tok rh4; MockFactory factory;
    ...
    function setUp() public {
        ...
        vault = new ChipBuybackVault3(INPM(address(npm)), IChipFactoryLite(address(factory)), address(rh4), address(weth),
            ISwapRouter02(address(0)), IPoolManager(address(0)), address(0), keeper, 5000);
    }
